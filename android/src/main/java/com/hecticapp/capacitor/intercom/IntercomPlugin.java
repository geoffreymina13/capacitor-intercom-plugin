package com.hecticapp.capacitor.intercom;
...
public class IntercomPlugin extends Plugin {
    public static final String CONFIG_KEY_PREFIX = "plugins.IntercomPlugin.";

    @Override()
    public void load() {
        //
        // get config
        String apiKey = this.bridge.getConfig().getString(CONFIG_KEY_PREFIX + "android-ApiKey", "ADD_IN_CAPACITOR_CONFIG_JSON");
        String appId = this.bridge.getConfig().getString(CONFIG_KEY_PREFIX + "intercom-AppId", "ADD_IN_CAPACITOR_CONFIG_JSON");
